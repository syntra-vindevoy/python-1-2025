...
class Board:
    ...
    def populate(self):
        ...
        # White pawns
        # self._put(piece = Pawn(color="white"), position = "A2")
        # self._put(piece = Pawn(color="white"), position = "B2")
        # self._put(piece = Pawn(color="white"), position = "C2")
        # self._put(piece = Pawn(color="white"), position = "D2")
        # self._put(piece = Pawn(color="white"), position = "E2")
        # self._put(piece = Pawn(color="white"), position = "F2")
        # self._put(piece = Pawn(color="white"), position = "G2")
        # self._put(piece = Pawn(color="white"), position = "H2")
        ...
        # self._put(piece = Pawn(color="black"), position = "A7")
        # self._put(piece = Pawn(color="black"), position = "B7")
        # self._put(piece = Pawn(color="black"), position = "C7")
        # self._put(piece = Pawn(color="black"), position = "D7")
        # self._put(piece = Pawn(color="black"), position = "E7")
        # self._put(piece = Pawn(color="black"), position = "F7")
        # self._put(piece = Pawn(color="black"), position = "G7")
        # self._put(piece = Pawn(color="black"), position = "H7")
